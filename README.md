...
- ### 📝 Code Editors
  ...
  - `FDM` [Fastedit](https://github.com/FrozenAssassine/Fastedit) <sup>`FOSS`</sup>
  - `FDM` [Code Writer](https://www.microsoft.com/store/productId/9WZDNCRFHZDT?ocid=pdpshare)
  - `FDM` [ConTeXt IDE](https://apps.microsoft.com/detail/context-ide/9NN9Q389TTJR?gl=MX&hl=lv-LV)
  - `FDM` [FluentEdit](https://apps.microsoft.com/store/detail/fluentedit/9NWL9M9JPQ36)
...
- ### ☑️ To-Do
  ...
  - `FDM` [AlertMe](https://apps.microsoft.com/store/detail/alertme-quick-reminder-notifications/9MW5VRL0BQT9) <sup>`💰`</sup>
  - `FD` [Microsoft To Do](https://www.microsoft.com/store/productId/9NBLGGH5R558?ocid=pdpshare)
...
- ### 📄 Pdf viewer
  - `FDM` [Fluetro PDF](https://apps.microsoft.com/store/detail/fluetro-pdf/9NSR7B2LT6LN)

- ### 📰 News
  - `FDM` [Fluent Feeds](https://github.com/hannesschulze/fluent-feeds) <sup>`FOSS`</sup>
  - `FDM` [Fluent HN - Hacker News client](https://apps.microsoft.com/store/detail/fluent-hn-hacker-news-client/9N8PDZHCPQHX) <sup>`💰`</sup>

- ### 🎙️ Podcasts
  - `FDM` [FluentCast](https://apps.microsoft.com/store/detail/fluentcast/9PM46JRSDQQR)
...
- ### 🛠️ Tools
  ...
  - `FDM` [PDF Unlocker - Unlock PDF, Remove Password](https://apps.microsoft.com/store/detail/pdf-unlocker-unlock-pdf-remove-password/9P20WBQVFD4N)
  - `FDM` [Pdf.JPG - PDF to JPG, PDF Converter](https://apps.microsoft.com/store/detail/pdfjpg-pdf-to-jpg-pdf-converter/9NJ9N3MG9JLW)
...
- ### 🛠️ Other Utilities
  ...
  - `FDM` [PocketCFD](https://apps.microsoft.com/store/detail/pocketcfd/9P9QZD92NR3F)
  - `FDM` [A.Click - Auto Click, Auto Clicker](https://apps.microsoft.com/store/detail/aclick-auto-clicker/9MV9MFVB6R5V)
  - `FDM` [Lecture Countdown](https://apps.microsoft.com/store/detail/lecture-countdown/9P4NPSWTX7LK)
  - `FDM` [Pillbox Pro](https://apps.microsoft.com/store/detail/pillbox-pro/9MZGZMJWFZSJ)
  - `FDM` [Dropshelf](https://apps.microsoft.com/store/detail/dropshelf/9MZPC6P14L7N)
  - `FDM` [FluentWeather](https://apps.microsoft.com/store/detail/fluentweather/9PFD136M8457)
  - `FDM` [TaskbarWebsites](https://apps.microsoft.com/store/detail/taskbarwebsites/9MZ8WTK48VHT) <sup>`💰`</sup>
  - `FDM` [Backup My Files](https://www.microsoft.com/store/apps/9P977JGV4VFB) <sup>`💰`</sup>
  - `FDM` [Desktop Toolkit](https://apps.microsoft.com/store/detail/desktop-toolkit/9N8PFLMMR9BW) <sup>`💰`</sup>
  - `FDM` [WiFiSpy - Who Is On My WiFi](https://apps.microsoft.com/store/detail/wifispy-who-is-on-my-wifi/9N64F7V2KSZH) <sup>`💰`</sup>
